        ...
        <header>
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 ">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl drop-shadow-2xl">
                    ...
                    <p class="from-pr-400  font-car font-medium text-5xl ">luxyCar</p>
                    </a>
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="/">
                                    <div class="group text-center">
                                        <div class="group-hover:cursor-pointer">Accueil</div>
                                        <div
                            ...
                            <li>
                                <a href="/contact_us">
                                    <div class="group text-center">
                                        <div class="group-hover:cursor-pointer">Contacter Nous</div>
                                        <div
            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    <div class="mb-12 md:mb-0 flex justify-center ">
                        ...
                        <p class="text-gray-100 font-car font-medium text-5xl ">luxyCar</p>
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/SoufianeRefaiCoding" class="hover:underline "
                                        target='_blank'>Github</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/soufiane-refai/" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2024 <a
                            ...
                            class="hover:underline">Soufiane refai</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.linkedin.com/in/soufiane-refai/" target='_blank'
                            class="text-gray-500  hover:text-white">
                        ...
                        <a href="https://www.instagram.com/soufianerefai_coding/" target='_blank'
                            class="text-gray-500  hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
