        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    <h1 class=" md:text-start text-center  font-car font-bold text-gray-900 mb-8  md:text-7xl text-4xl "><span class="text-pr-400"> FACILE 
                        </span>ET
                        RAPIDE POUR LOUER VOTRE VOITURE</h1>
                    <div class="md:w-3/5 md:hidden  ">
                        <img loading="lazy" src="/images/home car.png" alt="home car">
                    </div>
                    <p class="text-justify md:mx-0 mx-8 ">Que vous planifiiez une escapade le temps d’un week-end ou une aventure à travers le pays, nous avons ce qu’il vous faut. Avec notre large sélection de véhicules et notre système de réservation pratique, louer une voiture n’a jamais été aussi simple.</p>
                    <div class="flex justify-center md:justify-start mt-12 md:w-2/3 me-12 md:-ms-12">
                        ...
                        <a href="/contact_us">
                            <button class="border-2 border-pr-400 text-black w-32 p-2 rounded-md hover:bg-sec-400">Contcter 
                                Nous</button>
                        </a>
                    </div>
                </div>
                <div class="md:w-3/5 hidden md:block  ">
                    <img loading="lazy" src="/images/home_car.png" alt="home car">
                </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                ...
                <div class="   md:mr-16 mr-4 mb-4 flex justify-end">
                    <a href="/cars">
                        <button
                            class="border-2 border-pr-400 text-black w-16 p-1 rounded-md hover:bg-pr-400 hover:text-white">Voir
                            Tout
                            </button>
                    </a>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">20</h3>
                            <p class="font-car  text-lg">Voitures de Luxe</p>
                        </div>
                    </div>
                    <div
                        class="flex justify-around md:w-1/3 text-center my-4 h-16 align-middle md:border-b-0 md:border-r-2 border-b-2 pb-4 border-white">
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">3000</h3>
                            <p class="font-car  text-lg">Réservations </p>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-screen-xl ">
                <div>
                    <h2 class="text-center font-car text-3xl font-medium text-pr-400"> <span
                            class=" text-gray-900">Pourquoi </span> Nous Choisir</h2>
                </div>
                <div class="mt-7 mb-16">
                    <p class="md:text-center text-xl text-justify mx-8 ">We
                    Nous mettons votre satisfaction au cœur de nos priorités et nous nous efforçons de rendre votre expérience de location de voiture aussi fluide que possible. Avec notre large sélection de véhicules bien entretenus, nos prix compétitifs et notre processus de réservation simple, vous pouvez compter sur nous pour répondre à vos besoins. Notre équipe de service client dédiée est disponible 24h/24 et 7j/7 pour vous assister, vous assurant ainsi de recevoir l'aide que vous méritez. Que vous ayez besoin d'une voiture pour une escapade de week-end ou un long road trip, choisissez-nous pour un voyage sans tracas et agréable.</p>
                </div>
                ...
                <div
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">Voitures de Luxe</h3>
                            <p class="font-car text-gray-700 text-sm "> Vivez l'excitation de conduire nos supercars haut de gamme qui laisseront une impression durable.</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm "> Profitez de la flexibilité d'une annulation gratuite, vous offrant la tranquillité d'esprit si vos plans changent.</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm ">Nous garantissons les meilleurs prix pour nos voitures de location, vous assurant d'obtenir le meilleur rapport qualité/prix.
                            </p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">Processus Simple
                            </h3>
                            <p class="font-car text-gray-700 text-sm ">Notre processus simplifié rend la location de voiture rapide et sans effort, vous faisant gagner du temps et de l'énergie.
                            </p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm ">Bénéficiez de nos services numériques pratiques, rendant votre expérience de location de voiture encore plus pratique et efficace.
